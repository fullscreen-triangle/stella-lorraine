...
if __name__ == '__main__':
    ...
    ax_img.axis('off')
    ax_img.set_title('Original Image: "Moriarty"\nProfessional Model, Italian Greyhound',
                     fontsize=14, fontweight='bold', pad=20)

    # Right side: 3D phase space
    ...
    fig.text(0.5, 0.02, f'Conjugate Correlation: r = {correlation:.6f}',
    ...
    output_file = 'moriarty_3d_phase_space_with_image.gif'
