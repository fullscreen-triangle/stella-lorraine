#!/usr/bin/env python3
"""
Recursion Module Test Script
==============================
Tests ALL components in the recursion module independently.

Components tested:
- dual_function
- network_extension
- processing_loop
- virtual_processor_acceleration
"""
...
print("="*70)
print("   RECURSION MODULE COMPREHENSIVE TEST")
print("="*70)

results_dir = os.path.join(os.path.dirname(__file__), '..', '..', 'results', 'recursion_module')
...
results_file = os.path.join(results_dir, f'recursion_test_{timestamp}.json')
...
ax1.set_title('Recursion Module Component Status', fontweight='bold')

ax2 = plt.subplot(2, 3, 2)
ax2.axis('off')
components_text = "RECURSION COMPONENTS:\n\n"
...
plt.suptitle('Recursion Module Comprehensive Test', fontsize=16, fontweight='bold')
plt.tight_layout()

figure_file = os.path.join(results_dir, f'recursion_test_{timestamp}.png')
plt.savefig(figure_file, dpi=300, bbox_inches='tight')
plt.show()

print("\n" + "="*70)
print("   RECURSION MODULE TEST COMPLETE")
print("="*70)
