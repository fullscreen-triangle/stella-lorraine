...
CLOCK 1 ({clock1['name']}):
  ...
  Min interval:      {clock1['min_interval']*1e6:.4f} μs
  Max interval:      {clock1['max_interval']*1e6:.4f} μs
...
CLOCK 2 ({clock2['name']}):
  ...
  Min interval:      {clock2['min_interval']*1e6:.4f} μs
  Max interval:      {clock2['max_interval']*1e6:.4f} μs
