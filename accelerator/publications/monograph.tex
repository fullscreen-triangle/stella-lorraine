...
\includepdf[pages=-,
  addtotoc={1, chapter, 1,
    {Paper 19. Partition-State Graph Search for Tandem Mass Spectrometry:
     Bidirectional Dijkstra in S-Entropy Space
     with Virtual Substate Transition States},
    paper:partgraph}
]{partition-graph/partition-graph.pdf}

\phantomsection
\includepdf[pages=-,
  addtotoc={1, chapter, 1,
    {Paper 20. Mean-Recovery as the Universal Physical Law:
     From Partition States to Electromagnetic Signals,
     with the Unified Signal Hypothesis as a Theorem},
    paper:unifiedsig}
]{unified-signal-hypothesis/unified-signal-hypothesis.pdf}
...
Twenty papers. One axiom. No free parameters beyond the caesium-133 calibration constant~$\alpha$.}\\[1ex]
